...
from hoptimiser.system_layouts.components.hydrogen_storage_unit import HydrogenStorageUnitNew
...
class SystemLayout:
    ...
    def _get_stack(self):
        return Stack(oem=self._kwargs['stack_oem'],
                     ...
                     efficiency_curve_base_year=self._kwargs['efficiency_curve_base_year'],
    ...
    def _get_hydrogen_storage_unit(self):
        return HydrogenStorageUnitNew(tank=self._get_tank(),
